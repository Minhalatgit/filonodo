...
export function WhatsAppButton({
  ...
  message = "Hi filo.nodo! I'd love to ask about a custom embroidery or handmade piece.",
  className = "",
  variant = "solid",
}: WhatsAppButtonProps) {
  ...
  const styles =
    variant === "solid"
      ...
      : variant === "outline"
        ? "border border-ink/20 text-ink hover:border-rose hover:text-rose"
        : "bg-rose/15 text-ink hover:bg-rose/25";
